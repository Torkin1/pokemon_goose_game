...
public class Game {
    ...
    private final List<Player> losers = new ArrayList<>();              // If a player lose the game is added to this list. Only bad players allowed Trump added to this
